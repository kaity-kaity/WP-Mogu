...
<head>
  ...
  <link rel="shortcut icon" href="./assets/img/common/mogu-logo.jpeg">
  ...
  <?php 
    ...
    wp_enqueue_script('mogu-main', get_template_directory_uri() . 'assets/js/main.js');
    wp_head(); 
  ?>
</head>
  ...
  <header class="header">
      <div class="header_inner">
        <div class="header_logo">
          <h1><a href="/"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/common/mogu-logo.jpeg"></a></h1>
        </div>
